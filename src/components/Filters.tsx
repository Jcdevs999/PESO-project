...
"Welding"
  ...
  const [ageRange, setAgeRange] = useState<{ from: number; to: number }>({ from: 18, to: 85 });
  // const [educationalLevel, setEducationalLevel] = useState<string>("All");
  const [educationalLevel, setEducationalLevel] = useState<string[]>(["Elementary Level", "Elementary Graduate",
    "Junior High School Level", "Junior High School Graduate", "Senior High School Level",
  ...
  if (!acceptGender && !acceptAge && !acceptEducational && !acceptSkills && (startDate === "All" || endDate === "All")) {
    return data;
  }

  return data.filter((item) => {
    const genderMatch = !acceptGender || gender === "All" || item.isMale === gender;
    const ageMatch = !acceptAge || (item.Age >= ageRange.from && item.Age <= ageRange.to);
    const educationMatch = !acceptEducational || educ === "All" || (item.HighestLevel && item.HighestLevel.split(',').includes(educ));
    const skillsMatch = !acceptSkills || skills === "All" || (item.SkillsAcquired && item.SkillsAcquired.split(',').includes(skills));
    ...
    return genderMatch && ageMatch && educationMatch && dateMatch && skillsMatch;
  }) || [];
}, [data, gender, ageRange, educationalLevel, skills, startDate, endDate, acceptGender, acceptAge, acceptEducational, acceptSkills]);
      ...
      datasets: [
        {
          ...
          tooltip: {
            callbacks: {
              label: (tooltipItem: TooltipItem<'pie'>) => {  // Specify the type here
  ...
  const maleCount = filteredData.filter((item) => item.isMale === "Male").length;
  const femaleCount = filteredData.filter((item) => item.isMale === "Female").length;
    ...
    if (acceptEducational) {
      const educCounts = educationalLevel.map(educ => {
        const count = filteredData.reduce((acc, item) => {
          if (item.HighestLevel && item.HighestLevel.split(',').includes(educ)) {
            acc += 1;
          }
          return acc;
        }, 0);
        console.log(`Educational Level: ${educ}, Count: ${count}`);
        return count;
      });
  

    chartData = {
      // labels: ["High School Graduate", "High School Level", "College Graduate", "College Level", "Vocational Graduate", "Elementary Graduate"],
      
      datasets: [
        {
          label: `Poll: Educational Level`,
          // data: [elementaryLevelCount, elementaryGraduateCount, juniorhighSchoolLevelCount, juniorhighSchoolGraduateCount, seniorhighSchoolLevelCount, seniorhighSchoolGraduateCount, vocationalLevelCount, vocationalGraduateCount, collegeLevelCount, collegeGraduateCount ],
          data: educCounts,
          backgroundColor: [
  ...
  if (acceptSkills) {
    const skillCounts = skillsOptions.map(skill => {
      const count = filteredData.reduce((acc, item) => {
        if (item.SkillsAcquired && item.SkillsAcquired.split(',').includes(skill)) {
          acc += 1;
        }
        return acc;
      }, 0);
      console.log(`Skill: ${skill}, Count: ${count}`);
      return count;
    });
  ...
  return chartData;
  }, [filteredData, gender, acceptGender, educationalLevel, acceptEducational, skills, acceptSkills, skillsOptions]);
  ...
  // Handlers for checkboxes
    ...
    const handleEducationalChecked = () => setAcceptEducational(!acceptEducational);
    ...
    <div>
      <div className=" gap-5 px-5 py-5 mb-5 grid grid-cols-[500px_1fr]">
        <form
          ...
          className="border-[2px] border-black flex flex-col items-end gap-5 px-5 py-5 rounded-xl"
        >
                    ...
                    <div className="w-full pl-[60px]">
                      <div className="border-[1px] border-black rounded-md w-fit px-2 py-1 mb-4 text-sm">
                        ...
                        >
                          ...
                          <option value="Accounting Skills">Accounting Skills</option>
                          <option value="Administrative Skills">Administrative Skills</option>
                          <option value="Advanced Computer Skills">Advanced Computer Skills</option>
                          <option value="Agricultural Skills">Agricultural Skills</option>
                          ...
                          <option value="Assembly Skills">Assembly Skills</option>
                          <option value="Assessment and Evaluation">Assessment and Evaluation</option>
                          <option value="Automotive Repair Skills">Automotive Repair Skills</option>
                          <option value="Automotive Skills">Automotive Skills</option>
                          <option value="Baking Skills">Baking Skills</option>
                          <option value="Beauty and Personal Care Skills">Beauty and Personal Care Skills</option>
                          <option value="Biology Skills">Biology Skills</option>
                          <option value="Business Skills">Business Skills</option>
                          <option value="Career Development Skills">Career Development Skills</option>
                          <option value="Carpentry">Carpentry</option>
                          <option value="Chemical Engineering Skills">Chemical Engineering Skills</option>
                          <option value="Child Development Skills">Child Development Skills</option>
                          <option value="Classroom Management">Classroom Management</option>
                          <option value="Clerical">Clerical</option>
                          <option value="Communication Skills">Communication Skills</option>
                          <option value="Community Development Skills">Community Development Skills</option>
                          <option value="Compliance Skills">Compliance Skills</option>
                          <option value="Computer Aided Design Skills">Computer Aided Design Skills</option>
                          <option value="Computer Literacy">Computer Literacy</option>
                          <option value="Computer-Aided Design Skills">Computer-Aided Design Skills</option>
                          <option value="Construction Management">Construction Management</option>
                          <option value="Construction Skills">Construction Skills</option>
                          <option value="Cosmetic and Personal Care Skills">Cosmetic and Personal Care Skills</option>
                          <option value="Counselling Skills">Counselling Skills</option>
                          <option value="Craftmanship">Craftmanship</option>
                          <option value="Creative Design">Creative Design</option>
                          <option value="Creative Skills">Creative Skills</option>
                          <option value="Culinary Production Skills">Culinary Production Skills</option>
                          <option value="Culinary Skills">Culinary Skills</option>
                          <option value="Customer Service Skills">Customer Service Skills</option>
                          <option value="Data Management">Data Management</option>
                          <option value="Design Skills">Design Skills</option>
                          <option value="Digital Marketing">Digital Marketing</option>
                          <option value="Digital Media Skills">Digital Media Skills</option>
                          <option value="Educational Skills">Educational Skills</option>
                          <option value="Electrical Skills">Electrical Skills</option>
                          <option value="Electronics Repair Skills">Electronics Repair Skills</option>
                          ...
                          <option value="Environmental Skills">Environmental Skills</option>
                          <option value="Equipment Operation">Equipment Operation</option>
                          <option value="Event Management Skills">Event Management Skills</option>
                          <option value="Facility Maintenance Skills">Facility Maintenance Skills</option>
                          <option value="Field Work">Field Work</option>
                          <option value="Financial Skills">Financial Skills</option>
                          <option value="Food & Beverage Skills">Food & Beverage Skills</option>
                          <option value="Food Safety">Food Safety</option>
                          <option value="General Assistance">General Assistance</option>
                          <option value="General Training Skills">General Training Skills</option>
                          <option value="Graphic Design Skills">Graphic Design Skills</option>
                          <option value="Health and Emergency Medical Skills">Health and Emergency Medical Skills</option>
                          <option value="Health and Safety Skills">Health and Safety Skills</option>
                          <option value="Health and Wellness Skills">Health and Wellness Skills</option>
                          ...
                          <option value="Hospitality Skills">Hospitality Skills</option>
                          ...
                          <option value="Landscape Artist">Landscape Artist</option>
                          ...
                          <option value="Maintenance Skills">Maintenance Skills</option>
                          <option value="Management Skills">Management Skills</option>
                          <option value="Manual Labor Skills">Manual Labor Skills</option>
                          <option value="Manufacturing and Production Skills">Manufacturing and Production Skills</option>
                          <option value="Marine Engineering">Marine Engineering</option>
                          <option value="Maritime Skills">Maritime Skills</option>
                          ...
                          <option value="Meat Cutting and Processing">Meat Cutting and Processing</option>
                          <option value="Mechanical Engineering">Mechanical Engineering</option>
                          <option value="Mechanical Skills">Mechanical Skills</option>
                          ...
                          <option value="Pipeline Engineer">Pipeline Engineer</option>
                          <option value="Poultry Husbandry">Poultry Husbandry</option>
                          ...
                          <option value="Regulatory Knowledge">Regulatory Knowledge</option>
                          <option value="Research Skills">Research Skills</option>
                          <option value="Retail Skills">Retail Skills</option>
                          <option value="Risk Assessment">Risk Assessment</option>
                          <option value="Safety">Safety</option>
                          <option value="Safety and Emergency Response Skills">Safety and Emergency Response Skills</option>
                          <option value="Seafaring Skills">Seafaring Skills</option>
                          <option value="Security Skills">Security Skills</option>
                          <option value="Social Services">Social Services</option>
                          <option value="Soft Skills">Soft Skills</option>
                          <option value="Sports Skills">Sports Skills</option>
                          <option value="Statistician">Statistician</option>
                          <option value="Stenography Skills">Stenography Skills</option>
                          <option value="Strategic Skills">Strategic Skills</option>
                          <option value="Surveying">Surveying</option>
                          <option value="System Analytical Skills">System Analytical Skills</option>
                          ...
                          <option value="Therapeutical Skills">Therapeutical Skills</option>
                          <option value="Tool and Equipment Knowledge">Tool and Equipment Knowledge</option>
                          <option value="Trade Skills">Trade Skills</option>
                          <option value="Transportation Skills">Transportation Skills</option>
        ...
        <div className="border-[2px] border-black flex flex-col items-start gap-5 px-5 py-5 rounded-xl">
